...
public static ArrayList<String> GetRecipesIdsByCategory(String categoryId) {
	System.out.println("GetRecipesIdsByName przejął nazwę " + categoryId);
	ArrayList<String> RecipesIds = new ArrayList<>();
	String result ="";
	String queryParameter = "";
	
	String QUERY_RECIPE_TOP_LOAD= "select id from recipes_header where id_category = ?";
...
public static ArrayList<TopRecipe> GetRecipeByCategory (String categoryId) {
	
	ArrayList<TopRecipe> listFoundRecipe = new ArrayList<>(); 
	ArrayList<String> RecipesIds = GetRecipesIdsByCategory(categoryId);
