  ...
  <main>
	<div class="conteiner">
			...
			<div class="offset-1 col-2 login" name="mainPage_Zdjecie" >
				<img src="img/risotto.jpg" alt="..." img style="vertical-align: middle">
			</div>
			...
			<div class="col-6 nazwa">
				...
				<div class="row">
			<div class="offset-1 col-2 login" name="mainPage_Zdjecie" >
				<img src="img/padthai.jpg" alt="..." img style="vertical-align: middle">
			</div>
			<div class="col-2 login" name="mainPage_Ocena">
				<h2> 4.5/5.0</h2>
			</div>
			<div class="col-6 nazwa">
				...
				<div class="row">
			<div class="offset-1 col-2 login" name="mainPage_Zdjecie" >
				<img src="img/krupnik.jpg" alt="..." img style="vertical-align: middle">
			</div>
			<div class="col-2 login" name="mainPage_Ocena">
				<h2> 4.3/5.0</h2>
			</div>
			<div class="col-6 nazwa">
				...
				<div class="row">
			<div class="offset-1 col-2 login" name="mainPage_Zdjecie" >
				<img src="img/schabowy.jpg" alt="..." img style="vertical-align: middle">
			</div>
			<div class="col-2 login" name="mainPage_Ocena">
				<h2> 4.1/5.0</h2>
			</div>
			<div class="col-6 nazwa">
				...
				<div class="row">
			<div class="offset-1 col-2 login" name="mainPage_Zdjecie" >
				<img src="img/pizzaananas.jpg" alt="..." img style="vertical-align: middle">
			</div>
			<div class="col-2 login" name="mainPage_Ocena">
				<h2> 1.5/5.0</h2>
			</div>
